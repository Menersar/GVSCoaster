...
// SPIFFS.format();
 ...
 // The extra parameters to be configured (can be either global or just in the setup)
  ...
  WiFiManagerParameter custom_mqtt_port("port", "Here a broker port", mqtt_port, 6);
    ...
    //WiFiManagerParameter custom_wifi_name("broker", "Here a server IP",wifi_name, 40);
  //WiFiManagerParameter custom_wifi_password("port", "Here a broker port", wifi_password, 70);
...
//  WiFiManagerParameter custom_wifi_password("p", "password", wifi_password, 64, "password");
...
//<input id='s' name='s' length=32 placeholder='SSID'><br/><input id='p' name='p' length=64 type='password' placeholder='password'><br/>
